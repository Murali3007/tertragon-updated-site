...
4. Test your changes. Follow [Development setup](/docs/docs/contribution-guide/development-setup) and
   [Running tests](/docs/docs/contribution-guide/running-tests) guides to build and test Tetragon.
...
7. Follow [Submitting a pull request](/docs/docs/contribution-guide/submitting-a-pull-request) guide to commit your changes
   and open a pull request.

## Making changes to documentation

To improve Tetragon documentation ([https://tetragon.io/](https://tetragon.io/)), please follow the
[documentation contribution guide](/docs/docs/contribution-guide/documentation).
...
- See how to [run the tests of the project](/docs/docs/contribution-guide/running-tests/).
