...
The instructions below extend the example from [Execution Monitoring](/docs/docs/getting-started/execution)
...
outlined in either the [Quick Kubernetes Install](/docs/docs/getting-started/install-k8s)
or the [Quick Docker Install](/docs/docs/getting-started/install-docker)
section.
...
To explore tracing policies for networking see the [Networking Monitoring](/docs/docs/getting-started/network)
section of the Getting Started guide.
To dive into the details of policies and events please see the [Concepts](/docs/docs/concepts/events)
