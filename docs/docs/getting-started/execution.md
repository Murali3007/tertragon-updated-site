...
<details>
<summary>Full output of a process execution event</summary>
...
[File Access Monitoring](/docs/docs/getting-started/file-events) section of the Getting Started guide.
To see a network policy check the [Networking Monitoring](/docs/docs/getting-started/network) section.
